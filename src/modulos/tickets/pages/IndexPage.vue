...
import { useQuasar, exportFile, QSpinnerFacebook } from "quasar";
import ModalComp from "../components/ModalComp.vue";
import TablaComp from "../components/TablaComp.vue";
import ModalArchivo from "../../../helpers/ModalArchivo.vue";
import ModalCompTicket from "../../mis_Tickets/components/ModalComp.vue";
...
import ModalDetalleSeguimiento from "src/modulos/mis_Actividades_Tickets/components/ModalDetalleSeguimiento.vue";
import ModalCambiarSolicitud from "../../../helpers/ModalCambiarSolicitud.vue";
...
const { list_Tickets_Filtro, list_Solicitudes_Tickets } = storeToRefs(
  ticketsSolicitudesStore
);
